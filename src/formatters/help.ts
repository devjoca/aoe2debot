export function buildHelpText(botUsername: string): string {
  return [
    ...
    "/trend <player> - pick Team Random or 1v1, then show ELO trend chart",
    "/civs <player> - pick Team Random or 1v1, then show civ preferences",
    "",
    "Group mention examples:",
    `@${botUsername} elo yayo`,
    `@${botUsername} last yayo`,
    `@${botUsername} last yayo 5`,
    `@${botUsername} trend yayo`,
    `@${botUsername} civs yayo`,
    "",
    "Notes:",
